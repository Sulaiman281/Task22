...
public class ItemObservableList {
    private final static ObservableList<Item> data = FXCollections.observableArrayList();

    private static TableView<Item> table = null;
    ...
    public static void loadData() {
        try {
            ...
            while (rs.next()) {
                ...
                data.add(new Item(salShort, addName, addHP));
            }
